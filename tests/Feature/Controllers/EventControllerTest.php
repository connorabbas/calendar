...
class EventControllerTest extends TestCase
{
    ...
    {
        $this->get(route('events.single', ['id' => 1]))->assertStatus(302);
    }
    ...
    public function test_get_returns_403_when_different_user()
    {
        ...
        $this->get(route('events.single', ['id' => $event->id]))->assertStatus(403);
    }
    ...
    public function test_get_returns_200_with_correct_user()
    {
        ...
        $this->actingAs($user);
        $this->get(route('events.single', ['id' => $event->id]))->assertStatus(200);
    }
